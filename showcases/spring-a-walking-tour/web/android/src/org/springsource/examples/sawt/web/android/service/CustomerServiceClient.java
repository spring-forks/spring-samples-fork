...
public class CustomerServiceClient  implements CustomerService {
    ...
    public Customer getCustomerById(long id) {
        return extractResponse(restTemplate.getForEntity(urlForPath("customer/{customerId}"), Customer.class, id));
    }

    @Override
    public Customer createCustomer(String fn, String ln) {
        return extractResponse(this.restTemplate.postForEntity(urlForPath("customers"), new Customer(fn, ln), Customer.class));
    }
}
