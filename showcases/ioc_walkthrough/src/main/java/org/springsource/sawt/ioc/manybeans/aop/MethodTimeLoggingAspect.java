...
/**
 * Simple {@link Aspect} that both filters out the candidate beans and
 * intercepts appropriately.
 * <p/>
 * You can decouple these two aspects appropriately into "pointcuts" and
 * "advice."
 * <p/>
...
public class MethodTimeLoggingAspect {
	...
	public Object logMethodTimes(ProceedingJoinPoint invocation)
			throws Throwable {
