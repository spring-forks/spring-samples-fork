...
/**
 * Simple config demonstrating some
 * {@link org.springframework.beans.factory.FactoryBean}s in action.
 * 
 */
@Configuration
@PropertySource("classpath:/config.properties")
@EnableTransactionManagement
// / nb: were transparently enabling transaction managment
public class Config {
	@Autowired
	...
	public SessionFactory hibernate3SessionFactory() throws Throwable {
		return new AnnotationSessionFactoryBuilder()
				...
				.setAnnotatedPackages(entityPackage).buildSessionFactory();
	}
}
