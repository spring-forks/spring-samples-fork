...
public class Main {
  ...
  static void runJmsTemplateExample() throws Throwable {
    ...
    ClassPathXmlApplicationContext classPathXmlApplicationContext = new ClassPathXmlApplicationContext("/jms-jmstemplate-consumer.xml");
  ...
  static void runMessageListenerContainerExample() throws Throwable {
    ClassPathXmlApplicationContext classPathXmlApplicationContext = new ClassPathXmlApplicationContext("/jms-message-listener-container-consumer.xml");
    classPathXmlApplicationContext.start();
